							...
							?>
								<tr>
									...
									<td class="empty" width="">
										<a data-placement="left" title="Click to Edit" id="edit<?php echo $id; ?>" href="editGolfKit.php<?php echo '?edit=' . $id; ?>&requestId=<?php echo $requestId?>" class="btn btn-success"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span></a>
