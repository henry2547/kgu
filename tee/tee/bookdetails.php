			...
			<div class="panel panel-success" id="outprint">
				<div class="panel panel-success">
					<div class="panel-heading">
						<h3 class="panel-title">Tee Time Details</h3>
					</div>
							...
							<div class="panel-body">
								<table id="myTable-party" class="table table-bordered table-hover" cellspacing="0" width="100%">
									...
									<tbody>
										<?php
										$sn = 0;
										$query = mysqli_query($dbcon, "SELECT booktee.*, golfer.*, teetime.*, available_tees.*, clubs.*
										FROM booktee
										JOIN golfer ON booktee.golferId = golfer.golferId
										JOIN teetime ON booktee.teeId = teetime.teeId
										...
										?>
											<tr>
												<td><b>Tee name:</b> <?php echo $row['tee_name'] ?><br><b>Price:</b> <?php echo $row['Price'] ?> Kshs<br><b>Remaining holes:</b> <?php echo $row['NumberOfHoles'] ?></td>
