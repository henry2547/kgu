...
<div class="container-fluid">
	...
	<div class="container-fluid">
		...
		<div class="col-md-8">
					...
					<div class="panel-body">
						...
						<div class="panel panel-success">
							<div class="panel-heading">
								...
								<h3 class="panel-title"> Club and Tournament Details</h3>
							</div>
							<div class="panel-body">
								<?php
								$query = mysqli_query($dbcon, "SELECT clubs.*, booktournament.*, tournament.*
								FROM clubs
								JOIN booktournament ON booktournament.clubId = clubs.clubId
			...
			<center>
				<a href="view_winners.php" class="btn btn-success">Return Home
