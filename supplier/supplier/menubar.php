	...
	<div class="panel-body">
		<div class="row">
			...
			<div class="col-md-3">
				<div class="panel panel-info">
					<div class="panel-heading">
						<h3 class="panel-title"> <a href="requested_golf_kits.php">
								<span class="glyphicon glyphicon-plus" aria-hidden="true"></span>

								Requested golf kits</a>
			...
			<div class="col-md-3">
				<div class="panel panel-info">
					<div class="panel-heading">
						<h3 class="panel-title"> <a href="receive_payments.php">
								<span class="glyphicon glyphicon-plus" aria-hidden="true"></span>
			...
			<div class="col-md-3">
				<div class="panel panel-info">
					<div class="panel-heading">
						<h3 class="panel-title"> <a href="my_payments.php">
								<span class="glyphicon glyphicon-plus" aria-hidden="true"></span>
